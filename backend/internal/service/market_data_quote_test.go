...
// --- CachedQuoteData tests ---

func TestCachedQuoteData_HitCache(t *testing.T) {
	callCount := 0
	...
	cached := service.NewCachedQuoteData(inner, 60*time.Second)
...
func TestCachedQuoteData_ExpiredCache(t *testing.T) {
	callCount := 0
	inner := &mockMarketData{
		GetQuoteFn: func(_ context.Context, symbol string) (*models.StockQuote, error) {
			callCount++
	...
	cached := service.NewCachedQuoteData(inner, 1*time.Millisecond)
...
func TestCachedQuoteData_BatchPartialCache(t *testing.T) {
	callCount := 0
	inner := &mockMarketData{
		GetQuoteFn: func(_ context.Context, symbol string) (*models.StockQuote, error) {
